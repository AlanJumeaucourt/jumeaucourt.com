...
const Projects = () => {
      ...
      en: {
        ...
        projects: {
          ...
          hit_or_flop: {
            title: "Hit or Flop",
            description:
              "AI model using convolutional neural networks to predict if a song has the characteristics of a hit. Built with Python and Next.js, deployed with Docker.",
            technical: [
          ...
          sirlightboard: {
            ...
            description:
              "Automation solution for recording and uploading educational content. Features OBS integration, file transfer automation, and custom Debian live CD for Lightboard teaching.",
            technical: [
          ...
          nas_project: {
            title: "NAS Project",
            description:
              "Python-based automation tool for provisioning MPLS/VPN network infrastructure. Configures Cisco routers based on JSON configuration files.",
            technical: [
          ...
          this_website: {
            title: "This Website",
            description:
              "The very website you're looking at right now! Built with React, Tailwind CSS, and probably too much coffee.",
            technical: [
          ...
          pasta_tower: {
            ...
            description:
              "My magnum opus: a towering testament to human ingenuity, built entirely from pasta and the sheer power of determination (and lots of scotch tape). This architectural marvel was born during a project management course where I decided to prove that anything is possible with enough carbs and sticky tape!",
            technical: [
      ...
      fr: {
        ...
        projects: {
          wealth_manager: {
            ...
            description:
              "Une application complète de gestion des finances personnelles construite avec React Native et Expo, avec suivi en temps réel du patrimoine, gestion multi-comptes et analyses intelligentes.",
            technical: [
          ...
          hit_or_flop: {
            title: "Hit or Flop",
            description:
              "Modèle d'IA utilisant des réseaux de neurones convolutifs pour prédire si une chanson a les caractéristiques d'un hit. Construit avec Python et Next.js, déployé avec Docker.",
            technical: [
          ...
          sirlightboard: {
            title: "SIR-Lightboard",
            description:
              "Solution d'automatisation pour l'enregistrement et le téléchargement de contenu éducatif. Intègre OBS, l'automatisation du transfert de fichiers et un CD live Debian personnalisé pour l'enseignement Lightboard.",
            technical: [
          ...
          nas_project: {
            title: "Projet NAS",
            description:
              "Outil d'automatisation Python pour le provisionnement d'infrastructure réseau MPLS/VPN. Configure les routeurs Cisco basés sur des fichiers de configuration JSON.",
            technical: [
  ...
  const currentProject = useMemo(() => projects[currentIndex], [currentIndex, projects]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 min-h-[500px] md:h-[700px]">
              ...
              <div className="flex h-48 sm:h-64 md:h-full w-full flex-col">
                <div className="relative flex-1 min-h-0">
                  ...
                  <img
                    src={
                      getDisplayedScreenshot(currentProject)?.[
                        deviceType === "mobile" ? "mobile" : "desktop"
                      ] ?? getImageForDevice(currentProject)
                    }
                    alt={
