...
const Hero = () => {
  ...
  const translations = {
    en: {
      ...
      description:
        "I turn coffee into code and make servers do what they're told. French, currently in Bucharest, but my code runs everywhere.",
      cta: {
        contact: "Let's Chat!",
    ...
    fr: {
      ...
      description:
        "Je transforme le café en code et je fais faire aux serveurs ce qu'on leur dit. Français, actuellement à Bucarest, mais mon code tourne partout.",
      cta: {
        contact: "On Discute !",
    ...
    <section className="min-h-screen flex items-center justify-center -mt-16">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8 flex justify-center space-x-4">
          <Server
            className="w-12 h-12 text-blue-400 animate-float"
        ...
        <h2 className="text-2xl text-gray-300 mb-8">{translations[language].title}</h2>
